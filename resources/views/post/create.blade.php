<x-app-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        ...
        <form method="POST" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="mt-10">
            @csrf
                ...
                <div class="mt-4">
                    ...
                    <textarea name="content" id="content" cols="30" rows="10" class="block mt-1 w-full"></textarea>
